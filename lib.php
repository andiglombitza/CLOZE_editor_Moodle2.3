...
class tinymce_texteditor extends texteditor {
    ...
    protected function get_init_params($elementid, array $options=null) {
        ...
        $params = array(
                    ...
                    'entity_encoding' => "raw",
                    'plugins' => "{$xmedia}advimage,clozeeditor, table,style,layer,advhr,advlink,emotions,inlinepopups,searchreplace,paste,directionality,fullscreen,moodlenolink,{$xemoticon}{$xdragmath}nonbreaking,contextmenu,insertdatetime,save,iespell,preview,print,noneditable,visualchars,xhtmlxtras,template,pagebreak,spellchecker",
                    ...
                    'theme_advanced_buttons2_add' => "|,cleanup,removeformat,pastetext,clozeeditor,pasteword,|,forecolor,backcolor,|,ltr,rtl",
